          ...
          <Container maxWidth='xl'  style={{ backgroundColor: '#353b46', height: '100%', width: '100%' }}>
            <Grid container spacing={2}>
              ...
              <Grid item sm={6} xs={12} md={3} lg={2}>
                <h5 style={{color:'white'}}>*Create a new entry by adding the day and filling out the fields.</h5>
              ...
              <Grid item sm={12} xs={12} md={6} lg={8} style={{marginTop:'15px'}}>
                ...
                <Button variant='contained' color='primary' style={{margin:'10px'}} onClick={() => { this.getBaby(); this.setState({toggle: 'baby'}) }}>Baby Entries</Button>
                <Button variant='contained' color='primary' style={{ margin: '10px' }} onClick={() => { console.log(dataStore); SaveFile(dataStore); }}>BabyDownload</Button>
                  {this.updateHide()}
                {this.updateBaby()}
                <Typography component='div' style={{marginTop: 80}}>
